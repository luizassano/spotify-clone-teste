...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Mock API call - substitua por uma chamada real posteriormente
    ...
    <MainLayout title="Cadastro - Spotify Clone">
      <div className={styles.container}>
        <Container className="text-center d-flex flex-column justify-content-center" style={{ maxWidth: '400px' }}>
          ...
          {success && <Alert variant="success" className="mb-4">Cadastro realizado com sucesso! Redirecionando...</Alert>}
